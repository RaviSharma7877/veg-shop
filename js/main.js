...
let clicked = JSON.parse(localStorage.getItem("isclicked"));
let btnclick = document.querySelector('.btn-clicked')
...
btnclick.addEventListener('click',()=>{
    ...
    //     themeCustomize.style.display = 'none'
    // })
    clicked = localStorage.setItem("isclicked",JSON.stringify("yes"));
